...
#define CBC_OPCODE_LIST \
  ...
  CBC_OPCODE (CBC_CALL_EVAL, CBC_HAS_POP_STACK_BYTE_ARG, -1) \
  CBC_OPCODE (CBC_CALL_EVAL_PUSH_RESULT, CBC_HAS_POP_STACK_BYTE_ARG, 0) \
  CBC_OPCODE (CBC_CALL_EVAL_BLOCK, CBC_HAS_POP_STACK_BYTE_ARG, -1) \
